...
function calculate(id,type){
    ...
    switch(type){
        ...
        case "gyro":
            ...
            break;
        case "normal":
            var sensi = id.replace(/_camera|_scope|_normal|_gyro/g, '');
            coefficient = gyro[sensi]/360;
            break;
    }
    var val = value*coefficient;
    document.getElementById(id+"_out").value = Math.round(val);
}